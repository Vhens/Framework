<template>
  <div class="gt-swipe" :style="{ height: height + 'px' }">
    <div class="gt-swipe-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="gt-swipe-indicators" v-show="showIndicators">
      <div class="gt-swipe-indicator" v-for="(page, $index) in pages" :key="$index" :class="{ 'active': $index === index }"></div>
    </div>
  </div>
</template>
