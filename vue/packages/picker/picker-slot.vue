<template>
  <div class="gt-picker-slot" :class="classNames" :style="flexStyle">
    <div v-if="!divider" ref="wrapper" class="gt-picker-slot-wrapper" :class="{ dragging: dragging }" :style="{ height: contentHeight + 'px' }">
      <div class="gt-picker-sub-item" v-for="itemValue of mutatingValues" :class="{ 'gt-picker-selected': itemValue === currentValue }" :style="{ height: itemHeight + 'px', lineHeight: itemHeight + 'px' }">
  ...
  export default {
    ...
    methods: {
      ...
      updateRotate: function(currentTranslate, pickerItems) {
        ...
        if (!pickerItems) {
          pickerItems = wrapper.querySelectorAll('.gt-picker-sub-item');
        }
        ...
        [].forEach.call(pickerItems, (item, index) => {
          ...
          if (Math.abs(percentage) > itemsFit) {
            addClass(item, 'gt-picker-item-far');
          } else {
            removeClass(item, 'gt-picker-item-far');
          }
        });
      },
      ...
      initEvents() {
        ...
        draggable(el, {
          start: (event) => {
            ...
            pickerItems = el.querySelectorAll('.gt-picker-sub-item');
          },
      ...
      doOnValuesChange() {
        var el = this.$el;
        var items = el.querySelectorAll('.gt-picker-sub-item');
