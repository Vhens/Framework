<template>
  <gt-popup class="gt-datetime-picker" v-model="visible" position="bottom">
    <gt-picker
      :slots="dateSlots"
      @change="onChange"
      :visible-item-count="visibleItemCount"
      class="gt-datetime-picker-content"
      ref="picker"
      show-toolbar>
        <template slot="toolbar">
          <span class="gt-datetime-picker-action gt-datetime-picker-cancel" @click="visible = false;$emit('cancel')">{{ cancelText }}</span>
          <span class="gt-datetime-picker-action gt-datetime-picker-confirm" @click="confirm">{{ confirmText }}</span>
        </template>
    </gt-picker>
  </gt-popup>
</template>
