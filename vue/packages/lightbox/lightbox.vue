<template>
  ...
  <div class="pswp gt-lightbox" tabindex="-1" role="dialog" aria-hidden="true">
...
import UI from '../../node_modules/photoswipe/dist/photoswipe-ui-default'
...
export default {
  ...
  methods: {
    init (index) {
      const self = this
      const showItem = this.getImgs[index]
    ...
    doInit (index) {
      ...
      this.photoswipe = new PhotoSwipe(this.$el, UI, this.getImgs, options)
